...
class albaran_detallado extends fs_controller
{
    ...
    protected function private_core()
    {
        ...
        if ($this->albaran) {
            ...
            if (!$this->cliente) {
                ...
                $this->enviar_email('nota de entrega', $_REQUEST['tipo']);
            } else {
    ...
    public function generar_albaran_pdf($archivomail = FALSE, $archivodownload = FALSE)
    {
        ...
        $pdf_doc->SetSubject('Nota de Entrega del cliente: ' . $this->albaran->nombrecliente);
        ...
        // Tipo de Documento
        $pdf_doc->fdf_tipodocumento = 'Nota de Entrega'; // (FACTURA, FACTURA PROFORMA, ¿ALBARAN, PRESUPUESTO?...)
