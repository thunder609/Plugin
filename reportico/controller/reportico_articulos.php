 ...
 */
class reportico_articulos extends fs_controller {
   ...
   protected function private_core() {
      ...
      if (isset($_GET['access_' . __CLASS__])) {
         ...
         // Activa/Desactiva tablas dinamicas
         $q->dynamic_grids = true;
         // Activa/Desactiva columnas de tablas ordenables de forma dinámica
         $q->dynamic_grids_sortable = true;
         // Activa/Desactiva buscador en columnas
         $q->dynamic_grids_searchable = true;
         // Activa/Desactiva paginación
         $q->dynamic_grids_paging = false;
         // Activa/Desactiva tamaño de pagina para al paginación
