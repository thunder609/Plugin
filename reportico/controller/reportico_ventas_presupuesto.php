 ...
 */
class reportico_ventas_presupuesto extends fs_controller {
   ...
   public function __construct() {
      ...
      $this->titulo_menu = 'Imprimir ' . FS_PRESUPUESTO;
      /// En la página desde la que se va a llegar a este informe
      $this->pagina_origen = 'ventas_presupuesto';
      /// Tipo de enlace
      $this->tipo_enlace = 'button';
      /// Nombre del reporte XML a utilizar
      $this->archivo_xml = "15-PresupuestosClientes";
   ...
   protected function private_core() {
      ...
      if (isset($_GET['access_' . __CLASS__])) {
         ...
         $q->initial_execution_parameters['idpresupuesto'] = intval($_GET['id']);
