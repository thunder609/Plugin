<?php
// -----------------------------------------------------------------------------
// -- Reportico config file generated from FacturaScripts ----------------------
// -----------------------------------------------------------------------------
// Module : config.php
//
...
define('SW_HTTP_BASEDIR', '/fs/');
define('SW_HTTP_URLHOST', 'http://127.0.0.1:80/fs/');
define('SW_DEFAULT_PROJECT', 'FacturaScripts');

// Project Title used at the top of menus
define('SW_PROJECT_TITLE', 'Reportes para FacturaScripts');
...
define('SW_DB_DATABASE', 'facturascripts');
}
define('SW_DB_CONNECT_FROM_CONFIG', true);
define('SW_DB_DATEFORMAT', 'YYYY-MM-DD');
define('SW_PREP_DATEFORMAT', 'YYYY-MM-DD');
define('SW_DB_SERVER', '');
...
define('PDF_HEADER_IMAGE', '../../../images/logo.png');
define('PDF_HEADER_XPOS', '10'); 
